...
The expensive W14 enumeration is unchanged from v9. Its exact C++17/OpenMP enumeration and disjoint-mask-search sources are included in the dedicated verification repository's `repro/`; the generated `w14_masks.bin` intermediate is intentionally not versioned.
